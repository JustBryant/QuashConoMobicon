...
public static class Modelflower_wolf extends EntityModel<Entity> {
	...
	public Modelflower_wolf() {
		...
		righttailflower4_r1.setTextureOffset(18, 38).addBox(-1.0297F, -4.7588F, -0.1955F, 1.0F, 3.0F, 0.0F, 0.0F,
				false);
		...
		frontmiddleBackFlowers.setTextureOffset(32, 24).addBox(-0.5F, -3.6527F, -0.2145F, 1.0F, 3.0F, 0.0F, 0.0F,
				false);
		...
		frontrightbackflowers.setTextureOffset(30, 43).addBox(0.7075F, -2.947F, -0.6693F, 1.0F, 2.0F, 0.0F, 0.0F,
				false);
		frontrightbackflowers.setTextureOffset(6, 38).addBox(-0.1981F, -2.2278F, -0.9895F, 1.0F, 2.0F, 0.0F, 0.0F,
				false);
