...
import net.mcreator.quashconomiestwo.item.QuashPaxelItem;
...
public class StripLogProcedure extends QuashconomiestwoModElements.ModElement {
	public StripLogProcedure(QuashconomiestwoModElements instance) {
		super(instance, 158);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				QuashconomiestwoMod.LOGGER.warn("Failed to load dependency entity for procedure StripLog!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				QuashconomiestwoMod.LOGGER.warn("Failed to load dependency x for procedure StripLog!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				QuashconomiestwoMod.LOGGER.warn("Failed to load dependency y for procedure StripLog!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				QuashconomiestwoMod.LOGGER.warn("Failed to load dependency z for procedure StripLog!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				QuashconomiestwoMod.LOGGER.warn("Failed to load dependency world for procedure StripLog!");
			return;
		}
		...
		if ((((entity instanceof LivingEntity) ? ((LivingEntity) entity).getHeldItemMainhand() : ItemStack.EMPTY)
			...
			}
			{
				...
				BlockState _bs = StrippedQuashLogBlock.block.getDefaultState();
		...
		if ((((entity instanceof LivingEntity) ? ((LivingEntity) entity).getHeldItemMainhand() : ItemStack.EMPTY)
			...
			{
				ItemStack _ist = new ItemStack(Items.NETHERITE_AXE, (int) (1));
				if (_ist.attemptDamageItem((int) 1, new Random(), null)) {
					_ist.shrink(1);
					_ist.setDamage(0);
				}
		...
		if ((((entity instanceof LivingEntity) ? ((LivingEntity) entity).getHeldItemMainhand() : ItemStack.EMPTY)
				.getItem() == new ItemStack(QuashPaxelItem.block, (int) (1)).getItem())) {
			{
				ItemStack _ist = new ItemStack(QuashPaxelItem.block, (int) (1));
				if (_ist.attemptDamageItem((int) 1, new Random(), null)) {
					_ist.shrink(1);
					_ist.setDamage(0);
				}
