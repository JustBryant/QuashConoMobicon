...
public class QuashStickItem extends QuashconomiestwoModElements.ModElement {
	@ObjectHolder("quashconomiestwo:quash_stick")
	public static final Item block = null;
	public QuashStickItem(QuashconomiestwoModElements instance) {
		super(instance, 34);
	}
