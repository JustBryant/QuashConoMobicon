...
public class TheGoodGoopItem extends QuashconomiestwoModElements.ModElement {
	@ObjectHolder("quashconomiestwo:the_good_goop")
	public static final Item block = null;
	public TheGoodGoopItem(QuashconomiestwoModElements instance) {
		super(instance, 60);
	}
