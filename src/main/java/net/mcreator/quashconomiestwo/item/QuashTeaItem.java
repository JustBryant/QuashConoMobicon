...
public class QuashTeaItem extends QuashconomiestwoModElements.ModElement {
	@ObjectHolder("quashconomiestwo:quash_tea")
	public static final Item block = null;
	public QuashTeaItem(QuashconomiestwoModElements instance) {
		super(instance, 2);
	}
