...
public class QuashcentOreBlock extends QuashconomiestwoModElements.ModElement {
	@ObjectHolder("quashconomiestwo:quashcent_ore")
	public static final Block block = null;
	public QuashcentOreBlock(QuashconomiestwoModElements instance) {
		super(instance, 6);
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		}, block.getDefaultState(), 9)).range(50).square().func_242731_b(25));
	}
}
