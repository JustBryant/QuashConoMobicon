...
public class QuashLeavesBlock extends QuashconomiestwoModElements.ModElement {
	@ObjectHolder("quashconomiestwo:quash_leaves")
	public static final Block block = null;
	public QuashLeavesBlock(QuashconomiestwoModElements instance) {
		super(instance, 80);
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		}, block.getDefaultState(), 8)).range(64).square().func_242731_b(10));
	}
}
