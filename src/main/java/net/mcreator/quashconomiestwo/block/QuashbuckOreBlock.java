...
public class QuashbuckOreBlock extends QuashconomiestwoModElements.ModElement {
	@ObjectHolder("quashconomiestwo:quashbuck_ore")
	public static final Block block = null;
	public QuashbuckOreBlock(QuashconomiestwoModElements instance) {
		super(instance, 7);
