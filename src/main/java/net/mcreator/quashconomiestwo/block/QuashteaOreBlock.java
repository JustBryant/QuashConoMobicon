...
public class QuashteaOreBlock extends QuashconomiestwoModElements.ModElement {
	@ObjectHolder("quashconomiestwo:quashtea_ore")
	public static final Block block = null;
	public QuashteaOreBlock(QuashconomiestwoModElements instance) {
		super(instance, 9);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(40f, 20f).setLightLevel(s -> 0).harvestLevel(3)
					.harvestTool(ToolType.PICKAXE).setNeedsPostProcessing((bs, br, bp) -> true).setEmmisiveRendering((bs, br, bp) -> true));
			setRegistryName("quashtea_ore");
		}
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		}, block.getDefaultState(), 3)).range(16).square().func_242731_b(1));
	}
}
