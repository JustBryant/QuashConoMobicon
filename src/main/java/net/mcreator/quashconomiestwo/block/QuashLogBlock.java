...
import net.mcreator.quashconomiestwo.procedures.StripLogProcedure;
...
public class QuashLogBlock extends QuashconomiestwoModElements.ModElement {
	@ObjectHolder("quashconomiestwo:quash_log")
	...
	public static class CustomBlock extends Block {
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				StripLogProcedure.executeProcedure($_dependencies);
			}
