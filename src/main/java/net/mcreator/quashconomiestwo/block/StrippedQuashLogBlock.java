...
public class StrippedQuashLogBlock extends QuashconomiestwoModElements.ModElement {
	@ObjectHolder("quashconomiestwo:stripped_quash_log")
	public static final Block block = null;
	public StrippedQuashLogBlock(QuashconomiestwoModElements instance) {
		super(instance, 82);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(3f, 10f).setLightLevel(s -> 0).harvestLevel(1)
					.harvestTool(ToolType.AXE).slipperiness(1f));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.SOUTH));
			setRegistryName("stripped_quash_log");
		}
